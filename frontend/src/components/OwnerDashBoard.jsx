      ...
      {!myShopData ? (
        <div className="flex justify-center item-center p-4 sm:p-6">
          <div className="w-full max-w-md bg-white shadow-lg rounded-2xl p-6 border border-gray-100 hover:shadow-2xl transition-shadow duration-300">
            <div className="flex flex-col items-center text-center">
              ...
              <button
                className="bg-[#ff4d2d] text-white px-5 sm:px-6 py-2 rounded-full shadow-md font-medium hover:bg-orange-600 transition-colors duration-200 "
        ...
        <div className="w-full flex flex-col items-center gap-6 px-4 sm:px-6">
          ...
          <div className="bg-white shadow-lg rounded-xl overflow-hidden border border-orange-100 hover:shadow-2xl transition-all duration-300 w-full max-w-3xl relative">
           <div className="absolute top-4 right-4 bg-[#ff4d2d] text-white p-2 rounded-full shadow-md hover:bg-orange-600 transition-colors duration-200 cursor-pointer" onClick={()=>navigate("/create-edit-shop")}>
            <FaPen size={20}/>
           </div>
            <img
          ...
          {myShopData.items.length==0 && <div className="flex justify-center item-center p-4 sm:p-6">
          <div className="w-full max-w-md bg-white shadow-lg rounded-2xl p-6 border border-gray-100 hover:shadow-2xl transition-shadow duration-300">
            <div className="flex flex-col items-center text-center">
              <FaUtensils className="text-[#ff4d2d] w-16 h-16 sm:w-20 sm:h-20 mb-4" />
              <h2 className="text-xl font-bold sm:text-2xl text-gray-800 mb-2">
            ...
            <div className="flex flex-col items-center gap-4 w-full max-w-3xl">
              {myShopData.items.map((item,ind)=>(
                <OwnerItemCard data={item} key={ind}/>
              ))}
            </div>
              }
        </div>
