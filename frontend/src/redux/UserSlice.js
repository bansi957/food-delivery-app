...
export const {updateOrderStatus,addToMyorders,setMyOrders,setUserData,setCity,setState,setCurrentAdress,setShopsInMyCity,addToCart,updateQuantity,removeCartItem}=userSlice.actions
